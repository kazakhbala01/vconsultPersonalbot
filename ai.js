...
Структура JSON:
{
  ...
  "extraBullets": [
    "Права на программное обеспечение остаются за Заказчиком.",
    "Все доработки и изменения, не входящие в первоначальный объем работ, будут обсуждаться отдельно."
  ]
}
...
- Добавляй стандартные IT-условия ВСЕГДА, минимум 2 пункта:
  • "Права на программное обеспечение остаются за Заказчиком."
  • "Все доработки и изменения, не входящие в первоначальный объем работ, будут обсуждаться отдельно."
- Если юзер упомянул техподдержку → добавь: "Техническая поддержка после внедрения будет стоить X ₸ ежемесячно."
- Если юзер упомянул другие условия → добавь их тоже
