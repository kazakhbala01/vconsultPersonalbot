        ...
        `Ты оформляешь коммерческое предложение от IT-компании. Из текста пользователя создай структурированное КП. ТОЛЬКО JSON:
{
  ...
  "paymentBullets":["30% — предоплата при подписании договора: ₸1 740 000","30% — промежуточный этап: ₸1 740 000","40% — после завершения работ: ₸2 320 000"],
  "extraBullets":[]
}
...
- paymentBullets: условия оплаты. Каждый пункт в формате "XX% — описание: ₸СУММА"
  * Суммы ВСЕГДА с ₸ СПЕРЕДИ и пробелами между разрядами, например: ₸1 740 000
  * "50/50" → ["50% — предоплата при подписании договора: ₸2 900 000","50% — после завершения работ и подписания акта: ₸2 900 000"]
  * "30/30/40" → ["30% — предоплата при подписании договора: ₸1 740 000","30% — промежуточный этап: ₸1 740 000","40% — после завершения работ: ₸2 320 000"]
